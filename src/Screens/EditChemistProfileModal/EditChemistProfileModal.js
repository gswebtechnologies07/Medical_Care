...
const EditChemistProfileModal = (props) => {
    console.log(props, "EditChemistProfileModalprops")
    ...
    const saveData = () => {
        ...
        dispatch(EditChemistProfileAction(payload, Id)).then(async (response) => {
...
export default EditChemistProfileModal
