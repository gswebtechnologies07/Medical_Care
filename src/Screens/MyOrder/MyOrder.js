    ...
    <WrapperContainer>
      ...
      <View style={{ flex: 0.20, justifyContent: 'center' }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', width: '100%' }}>
          ...
          text='Upcoming'
          style={{backgroundColor: selectedTab == 0 ? colors.blueColor : colors.whiteColor,
            borderRadius: 8, justifyContent: 'center', alignItems: 'center'
          }}
          textStyle={{ color: selectedTab == 0 ? colors.whiteColor : colors.blackColor, fontSize: textScale(16), alignSelf: 'center',
          fontFamily: fontFamily.semiBold, paddingHorizontal: moderateScale(12), paddingVertical: moderateScaleVertical(5)}}
          /> */}
