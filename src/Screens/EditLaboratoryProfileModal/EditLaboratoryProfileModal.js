...
import { EditLaboratoryProfileAction, Laboratory_ProfileAction } from '../../redux/Action/Laboratory_ProfileAction'
import navigationStrings from '../../Navigations/navigationStrings'

const EditLaboratoryProfileModal = (props) => {
    console.log(props, 'propspropsod')
    ...
    const saveData = () => {
        ...
        dispatch(EditLaboratoryProfileAction(payload, Id)).then(async (response) => {
            console.log(response, "response_Laboratory_EditLaboratoryProfileAction")
            if (response?.message === "Laboratory Update Successfully") {
...
export default EditLaboratoryProfileModal
