...
import { EditPhysiotherapistProfileAction, Physiotherapist_ProfileAction } from '../../redux/Action/PhysiotherapistProfileAction'

const EditPhysiotherepist_Profile = (props) => {
    console.log(props, 'propspropsEditPhysiotherepist_Profile')
    ...
    const physiotherepistId = props?.props?.route?.params?.id
    ...
    const saveData = () => {
        ...
        console.log(payload, "datadpayload")
        console.log("IdIdId",physiotherepistId)
        var formData = new FormData();
        formData.append({
            "LoginData": JSON.stringify({ payload, physiotherepistId }),
        });
        dispatch(EditPhysiotherapistProfileAction(payload, physiotherepistId)).then(async (response) => {
            console.log(response, "EditPhysiotherapistProfileAction")
            if (response?.message === "Physiotherepist Update Successfully") {
...
export default EditPhysiotherepist_Profile
