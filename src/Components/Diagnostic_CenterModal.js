...
import { Diaganostic_ProfileAction } from '../redux/Action/Diagnostic_CenterAction'
import navigationStrings from '../Navigations/navigationStrings'
// import ImagePicker from 'react-native-image-crop-picker';
// import { androidCameraPermission } from '../../permissions'


const Diagnostic_CenterModal = () => {
    ...
    const saveData = () => {
        ...
        dispatch(Diaganostic_ProfileAction(payload)).then(async (response) => {
            console.log(response, "response_Diaganostic_ProfileAction")
            if (response?.message === "Diaganostic successfully created") {
                // setLoader(false);
                console.log("Laboratory_created_successfully", response);
                navigation?.navigate(navigationStrings.DIAGNOSTIC_PROFILE, { id: response?.data?.id })
...
export default Diagnostic_CenterModal
